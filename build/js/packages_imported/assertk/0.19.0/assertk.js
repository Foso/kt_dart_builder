(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'opentest4k'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('opentest4k'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'assertk'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'assertk'.");
    }
    if (typeof opentest4k === 'undefined') {
      throw new Error("Error loading module 'assertk'. Its dependency 'opentest4k' was not found. Please, check whether 'opentest4k' is loaded prior to 'assertk'.");
    }
    root.assertk = factory(typeof assertk === 'undefined' ? {} : assertk, kotlin, opentest4k);
  }
}(this, function (_, Kotlin, $module$opentest4k) {
  'use strict';
  ...
  var MultipleFailuresError = $module$opentest4k.com.willowtreeapps.opentest4k.MultipleFailuresError;
  var AssertionFailedError_init = $module$opentest4k.com.willowtreeapps.opentest4k.AssertionFailedError_init_wspj0f$;
  var AssertionFailedError_init_0 = $module$opentest4k.com.willowtreeapps.opentest4k.AssertionFailedError_init_8f3c9$;
  ...
  Assert.prototype.given_qlkmfe$ = defineInlineFunction('assertk.assertk.Assert.given_qlkmfe$', wrapFunction(function () {
  ...
  Result$Companion.prototype.success_mh5how$ = function (value) {
    return new Result$Success(value);
  };
  Result$Companion.prototype.failure_lsqlk3$ = function (error) {
    return new Result$Failure(error);
  };
  Result$Companion.prototype.runCatching_klfg04$ = defineInlineFunction('assertk.assertk.Result.Companion.runCatching_klfg04$', wrapFunction(function () {
    var Throwable = Error;
    return function (block) {
      var tmp$;
      try {
        tmp$ = this.success_mh5how$(block());
      }
       catch (e) {
        if (Kotlin.isType(e, Throwable)) {
          tmp$ = this.failure_lsqlk3$(e);
        }
         else
          throw e;
      }
  ...
  Result.prototype.getOrNull = function () {
    if (Kotlin.isType(this, Result$Success))
      return this.value;
    else if (Kotlin.isType(this, Result$Failure))
      return null;
    else
      return Kotlin.noWhenBranchMatched();
  };
  ...
  Result$Success.prototype.copy_11rb$ = function (value) {
    return new Result$Success(value === void 0 ? this.value : value);
  };
  ...
  Result$Failure.prototype.copy_tcv7n7$ = function (error) {
  ...
  function all($receiver, message, body) {
    all_1($receiver, message, body, all$lambda);
  }
  function all$lambda_0(it) {
    return !it.isEmpty();
  }
  function all_0($receiver, body) {
    all_1($receiver, SoftFailure$Companion_getInstance().defaultMessage, body, all$lambda_0);
  }
  function all_1($receiver, message, body, failIf) {
    var $receiver_0 = new SoftFailure(message, failIf);
    var previousFailure = $receiver_0.pushFailure();
    try {
      body($receiver);
    }
    finally {
      $receiver_0.popFailure_wk8go1$(previousFailure);
      $receiver_0.invoke();
    }
  }
  function assert_0(f) {
    var $this = Result.Companion;
    var tmp$;
    try {
      tmp$ = $this.success_mh5how$(f());
    }
     catch (e) {
      if (Kotlin.isType(e, Throwable)) {
        tmp$ = $this.failure_lsqlk3$(e);
  ...
  var assertThat_1 = defineInlineFunction('assertk.assertk.assertThat_klfg04$', wrapFunction(function () {
    var Result = _.assertk.Result;
    var assertThat = _.assertk.assertThat_ou8slr$;
    var Throwable = Error;
    return function (f) {
      var $this = Result.Companion;
      var tmp$;
  ...
  var assertAll = defineInlineFunction('assertk.assertk.assertAll_o14v8n$', wrapFunction(function () {
    var Failure = _.assertk.Failure;
    return function (f) {
      var $receiver = Failure.Companion.soft();
      var previousFailure = $receiver.pushFailure();
      try {
        f();
      }
      finally {
        $receiver.popFailure_wk8go1$(previousFailure);
        $receiver.invoke();
      }
    };
  }));
  var catch_0 = defineInlineFunction('assertk.assertk.catch_o14v8n$', wrapFunction(function () {
    var Throwable = Error;
    return function (f) {
      try {
        f();
  ...
  function extracting$lambda(closure$f1) {
    return function (actual) {
      var transform = closure$f1;
      var destination = ArrayList_init_0(actual.length);
      var tmp$;
      for (tmp$ = 0; tmp$ !== actual.length; ++tmp$) {
        var item = actual[tmp$];
  ...
  function extracting($receiver, f1) {
    return $receiver.transform_r2ivs0$(void 0, extracting$lambda(f1));
  }
  function extracting$lambda_0(closure$f1, closure$f2) {
    return function (actual) {
      var destination = ArrayList_init_0(actual.length);
      var tmp$;
      for (tmp$ = 0; tmp$ !== actual.length; ++tmp$) {
        ...
        var closure$f1_0 = closure$f1;
        var closure$f2_0 = closure$f2;
        tmp$_0.call(destination, to(closure$f1_0(item), closure$f2_0(item)));
      }
      return destination;
    };
  }
  function extracting_0($receiver, f1, f2) {
    return $receiver.transform_r2ivs0$(void 0, extracting$lambda_0(f1, f2));
  }
  function extracting$lambda_1(closure$f1, closure$f2, closure$f3) {
    return function (actual) {
      var destination = ArrayList_init_0(actual.length);
      var tmp$;
      for (tmp$ = 0; tmp$ !== actual.length; ++tmp$) {
        ...
        var closure$f1_0 = closure$f1;
        var closure$f2_0 = closure$f2;
        var closure$f3_0 = closure$f3;
        tmp$_0.call(destination, new Triple(closure$f1_0(item), closure$f2_0(item), closure$f3_0(item)));
      }
      return destination;
    };
  }
  function extracting_1($receiver, f1, f2, f3) {
    return $receiver.transform_r2ivs0$(void 0, extracting$lambda_1(f1, f2, f3));
  }
  ...
  function extracting$lambda_2(closure$f1) {
    return function (actual) {
      var transform = closure$f1;
  ...
  function extracting_2($receiver, f1) {
    return $receiver.transform_r2ivs0$(void 0, extracting$lambda_2(f1));
  }
  function extracting$lambda_3(closure$f1, closure$f2) {
    return function (actual) {
      var destination = ArrayList_init_0(collectionSizeOrDefault(actual, 10));
      var tmp$;
      tmp$ = actual.iterator();
  ...
  function extracting_3($receiver, f1, f2) {
    return $receiver.transform_r2ivs0$(void 0, extracting$lambda_3(f1, f2));
  }
  function extracting$lambda_4(closure$f1, closure$f2, closure$f3) {
    return function (actual) {
      var destination = ArrayList_init_0(collectionSizeOrDefault(actual, 10));
      var tmp$;
      tmp$ = actual.iterator();
  ...
  function extracting_4($receiver, f1, f2, f3) {
    return $receiver.transform_r2ivs0$(void 0, extracting$lambda_4(f1, f2, f3));
  }
  ...
  function isSuccess$lambda(this$isSuccess) {
    return function (actual) {
      var tmp$;
      return (tmp$ = actual.getOrNull()) != null ? tmp$ : expected(this$isSuccess, 'success but was failure:' + showError(ensureNotNull(actual.exceptionOrNull())));
    };
  }
  function isSuccess($receiver) {
    return $receiver.transform_r2ivs0$(void 0, isSuccess$lambda($receiver));
  }
  function isFailure$lambda(this$isFailure) {
    return function (actual) {
      var tmp$;
      return (tmp$ = actual.exceptionOrNull()) != null ? tmp$ : expected(this$isFailure, 'failure but was success:' + show(actual.getOrNull()));
    };
  }
  function isFailure($receiver) {
    return $receiver.transform_r2ivs0$(void 0, isFailure$lambda($receiver));
  }
  ...
  function messageContains($receiver, text) {
    contains_20(isNotNull_0(message($receiver)), text);
  }
  ...
  function hasCause($receiver, cause_0) {
    all_0(isNotNull_0(cause($receiver)), hasCause$lambda(cause_0));
  }
  ...
  FailureContext.prototype.pushFailure_wk8go1$ = function (failure) {
    var previousFailure = get_value(this.failureRef_0);
    if (equals(previousFailure, SimpleFailure_getInstance())) {
      set_value(this.failureRef_0, failure);
    }
    return previousFailure;
  };
  FailureContext.prototype.popFailure_wk8go1$ = function (previousFailure) {
    set_value(this.failureRef_0, previousFailure);
  };
  FailureContext.prototype.fail_55d06l$ = function (error) {
    get_value(this.failureRef_0).fail_55d06l$(error);
  };
  function FailureContext$failureRef$lambda() {
    return SimpleFailure_getInstance();
  }
  ...
  Failure.prototype.pushFailure = function () {
    return FailureContext_getInstance().pushFailure_wk8go1$(this);
  };
  Failure.prototype.popFailure_wk8go1$ = function (previousFailure) {
    FailureContext_getInstance().popFailure_wk8go1$(previousFailure);
  };
  ...
  var run = defineInlineFunction('assertk.assertk.run_hxi1xy$', function ($receiver, f) {
    var previousFailure = $receiver.pushFailure();
    try {
      return f();
    }
  ...
  SoftFailure.prototype.invoke = function () {
    if (this.failIf(this.failures_0)) {
      FailureContext_getInstance().fail_55d06l$(this.compositeErrorMessage_0(this.failures_0));
    }
  };
  ...
  function notifyFailure(e) {
    FailureContext_getInstance().fail_55d06l$(Kotlin.isType(e, AssertionError) ? e : AssertionError_init(e));
  }
  ...
  var failWithNotInStacktrace = defineInlineFunction('assertk.assertk.failWithNotInStacktrace_u2enfu$', function (error) {
    throw error;
  });
  ...
  package$assertk.thrownError_7h81o6$ = thrownError;
  package$assertk.returnedValue_11l08r$ = returnedValue;
  package$assertk.doesNotThrowAnyException_kzj5kq$ = doesNotThrowAnyException;
  Object.defineProperty(Result, 'Companion', {
    get: Result$Companion_getInstance
  });
  package$assertk.Result = Result;
  ...
  package$assertions.isSuccess_kzj5kq$ = isSuccess;
  package$assertions.isFailure_kzj5kq$ = isFailure;
  ...
  SimpleFailure.prototype.popFailure_wk8go1$ = Failure.prototype.popFailure_wk8go1$;
  SoftFailure.prototype.pushFailure = Failure.prototype.pushFailure;
  SoftFailure.prototype.popFailure_wk8go1$ = Failure.prototype.popFailure_wk8go1$;
  TableFailure.prototype.pushFailure = Failure.prototype.pushFailure;
  TableFailure.prototype.popFailure_wk8go1$ = Failure.prototype.popFailure_wk8go1$;
  MAX_CONTEXT_LENGTH = 20;
  NONE = new Any();
  Kotlin.defineModule('assertk', _);
  return _;
}));

//# sourceMappingURL=assertk.js.map
